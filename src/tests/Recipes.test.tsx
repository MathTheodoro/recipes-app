...
describe('Testes do componente Recipes', () => {
  test('renders Meals component when title is Meals', () => {
    render(
      <MemoryRouter>
        <Recipes title="Meals" />
      </MemoryRouter>,
    );
    const mealsElement = screen.getByText(/Meals/i);
    expect(mealsElement).toBeInTheDocument();
  });

  test('renders Drinks component when title is Drinks', () => {
    render(
      <MemoryRouter>
        <Recipes title="Drinks" />
      </MemoryRouter>,
    );
    const drinksElement = screen.getByText(/Drinks/i);
